...
//                   </Typography>
//                 </Box>Our team is working hard to bring you the latest updates and offers. Stay tuned for exciting announcements and seasonal promotions tailored for our valued partners.
//                 <Box sx={{ display: "flex", justifyContent: "space-between" }}>
//                   <Typography variant="body2" fontWeight="bold">
//                     Location:
//                   </Typography>
...
//   const [openEditDialog, setOpenEditDialog] = useState(false);
//
//   // State aligned with Dealer + User entities
//   const [profileData, setProfileData] = useState({
//     name: "Verizon Dealer", // Dealer.name
//     owner: "Anna Adame", // Dealer.owner
//     location: "California, United States", // Dealer.location
//     website: "www.verizon.com", // Dealer.website
//     contactEmail: "daveadame@verizon.com", // Dealer.contactEmail
//     logo: "/static/images/avatar/anna.jpg", // Dealer.logo (URL or path)
//     tier: "Gold Partner", // Optional: from DealerTier.name (simulated here)
//     username: "anna_adame", // User.username
//   });
//
//   const handleOpenEditDialog = () => {
//     setOpenEditDialog(true);
...
//                 {profileData.tier || "No tier assigned"}
//               </Typography>
//               <Box sx={{ width: "100%", mb: 2 }}>
//                 <Box
//                   sx={{
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updatedProfile = {
        ...
        tierName: dealer?.tier?.name || profileData.tierName,
      };
