...
const HqLeadsAdminPage = () => {
  ...
  const handleCreateSetting = async () => {
    try {
      await post('/admin/hq-leads/settings', newSetting);
              ...
              <CardContent>
                ...
                >
                  <FormControl fullWidth sx={{ mb: 2 }}>
                    <InputLabel id="package-tier-label">
                      Package Tier
                    </InputLabel>
                    <Select
                      ...
                      onChange={(e) =>
                        setNewSetting({
                          ...newSetting,
                          packageTier: e.target.value as string,
                        })
                      }
                    >
            ...
            <Grid container spacing={3} sx={{ mt: 2 }}>
              ...
              <Grid item xs={12} md={6}>
                <Paper sx={{ p: 2 }}>
                  ...
                  <Box sx={{ display: 'flex', gap: 2, mt: 1 }}>
                    <TextField label="Lead ID" type="number" sx={{ flex: 1 }} />
                    <TextField
                      label="Dealer ID"
                      type="number"
                      sx={{ flex: 1 }}
