...
import { Plus, Search, MoreHorizontal, Star, Filter, Download, Eye, Edit, Trash2 } from "lucide-react"
import { CompanyDialog } from "@/components/companies/form"
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="text-lg font-medium">Companies List</CardTitle>
            ...
            <TableBody>
              {filteredCompanies.map((company) => (
                <TableRow key={company.id} className="border-b">
                  ...
                  <TableCell>
                    <div className="font-medium text-foreground">{company.owner}</div>
                  </TableCell>
                  <TableCell>
